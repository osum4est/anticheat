...
namespace TerraUI.Objects {
    public class UIObject {
        ...
        protected Stopwatch lastClickTimer = new Stopwatch();
        protected int doubleClickMillis = 150;
        ...
        public virtual void Handle() {
            ...
            if(MouseUtils.AnyButtonPressed(out button)) {
                ...
                if (DoubleClick != null && button == MouseButtons.Left && 
                    lastClickTimer.IsRunning && lastClickTimer.ElapsedMilliseconds < doubleClickMillis && lastClickTimer.ElapsedMilliseconds > 20)
                {
                    DoubleClick(this, new MouseButtonEventArgs(button, MouseUtils.Position));
                    lastClickTimer.Stop();
                }
                else
                {
